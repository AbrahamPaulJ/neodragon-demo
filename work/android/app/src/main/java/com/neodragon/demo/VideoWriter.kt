...
object VideoWriter {
    ...
    fun write(
        ...
        frames: List<Bitmap>,
        fps: Int = 24,
        displayName: String = "neodragon_${System.currentTimeMillis()}.mp4",
        log: (String) -> Unit = {},
    ): Uri {
        ...
        val tmp = File(ctx.cacheDir, "nd_encode.mp4")
        ...
        val values = ContentValues().apply {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                put(MediaStore.Video.Media.RELATIVE_PATH, "Movies/Neodragon")
        ...
        log("      saved ${tmp.length() / 1024} KB -> Movies/Neodragon/$displayName")
        tmp.delete()
        return uri
    }
}
